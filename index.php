    ...
    <body class="crm_body_bg">
        ...
        <nav class="sidebar">
            <div class="logo d-flex justify-content-between">
                ...
                <a class="small_logo" href="index-2.html"><img
                ...
                <div class="row">
                    <div class="col-lg-12 p-0 ">
                        <div
                            ...
                            <div
                                class="line_icon open_miniSide d-none d-lg-block">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <li>
                                        <a class="bell_notification_clicker"
                                            href="#"> <img
            ...
            <div class="main_content_iner overly_inner ">
                <div class="container-fluid p-0 ">
                    <div class="row">
                        <div class="col-12">
                            <div
                                ...
                                <div
                                    class="page_title_left d-flex align-items-center">
                                ...
                                <div class="page_title_right">
                                    <div
                                        class="page_date_button d-flex align-items-center">
                                        <img src="img/icon/calender_icon.svg"
                                            alt>
                    ...
                    <div class="row ">
                            ...
                            <div class="white_card mb_30 card_height_100">
                                <div class="white_card_header">
                                    <div
                                        ...
                                        <div
                                            class="col-lg-4 text-end d-flex justify-content-end">
                                            <select
                        ...
                        <div class="col-xl-4 ">
                            <div
                                class="white_card card_height_100 mb_30 user_crm_wrapper">
                                <b>Current Month's</b>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="single_crm">
                                            <div
                                                ...
                                                <div class="thumb">
                                                    <img
                                                        src="img/crm/businessman.svg"
                                                        alt>
                                                </div>
                                                <i
                                                    class="fas fa-ellipsis-h f_s_11 white_text"></i>
                                            </div>
                                            <div class="crm_body">
